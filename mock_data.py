...
MOCK_COURSES = [
    {
        ...
        'description': '经典机器学习课程，涵盖监督学习、非监督学习和实践案例。',
        'cover_image': None,
        'url': '#',
        'created_at': datetime.now() - timedelta(days=10)
    },
    {
        'id': 102,
        'title': '深度学习专项课程（Deep Learning Specialization）',
        'platform': 'Coursera',
        'description': '系统学习神经网络、CNN、RNN 与优化方法。',
        'cover_image': None,
        'url': '#',
        'created_at': datetime.now() - timedelta(days=5)
    }
...
MOCK_RESOURCES = [
    ...
    },
    {
        ...
        'type_mini': '论文/期刊',
        'level': '专业前沿',
        'description': '扩散模型在图像生成任务中超越 GAN 的研究论文。',
        'cover_image': None,
        'url': '#',
        'created_at': datetime.now() - timedelta(days=7)
    }
